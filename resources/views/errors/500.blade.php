...
<html lang="en">
    <head>
        ...
        <title>Something went wrong — {{ config('app.name', 'ValeCheck') }}</title>
    ...
    <body class="font-sans antialiased bg-white text-vale-navy">
        <div class="min-h-screen flex flex-col items-center justify-center px-4 text-center">
            ...
            <h1 class="font-display font-bold text-3xl text-vale-navy">Something went wrong</h1>
            <p class="text-gray-500 mt-3 max-w-sm">
                We've hit a snag on our end. Our team's been notified — please try again in a moment.
            </p>
